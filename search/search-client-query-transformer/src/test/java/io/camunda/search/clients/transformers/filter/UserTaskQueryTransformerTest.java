...
public class UserTaskQueryTransformerTest extends AbstractTransformerTest {
  ...
  public void shouldQueryOnlyByUserTasks() {
    ...
    // then
    final SearchQueryOption queryVariant = searchRequest.searchOption();
    ...
    assertThat(queryVariant)
        .isInstanceOfSatisfying(
            SearchBoolQuery.class,
            (t) -> {
              assertThat(t.must().get(1).searchOption())
                  .isInstanceOfSatisfying(
  ...
  public void shouldQueryByUserTaskKey() {
    ...
    assertThat(queryVariant)
        .isInstanceOfSatisfying(
            SearchBoolQuery.class,
            (t) -> {
              assertThat(t.must().get(0).searchOption())
                  .isInstanceOfSatisfying(
                      SearchTermQuery.class,
                      (term) -> {
    ...
    assertThat(queryVariant)
        .isInstanceOfSatisfying(
            ...
            outerBoolQuery -> {
              ...
              assertThat(outerMustQuery.searchOption()).isInstanceOf(SearchHasParentQuery.class);

              // Drill down into the nested SearchBoolQuery
              final SearchHasParentQuery nestedHasParentQuery =
                  (SearchHasParentQuery) outerMustQuery.searchOption();
              ...
              final SearchHasChildQuery childQuery =
                  (SearchHasChildQuery) nestedHasParentQuery.query().searchOption();
              ...
              final SearchBoolQuery innerBoolQuery =
                  (SearchBoolQuery) childQuery.query().searchOption();
              assertThat(innerBoolQuery.must()).hasSize(2);

              assertThat(innerBoolQuery.must().get(0).searchOption())
                  .isInstanceOfSatisfying(
                      SearchTermQuery.class,
                      termQuery -> {
              ...
              assertThat(innerBoolQuery.must().get(1).searchOption())
                  .isInstanceOfSatisfying(
                      SearchTermQuery.class,
                      termQuery -> {
