...
public class UserTaskQueryTransformerTest extends AbstractTransformerTest {
  ...
  public void shouldQueryOnlyByUserTasks() {
    ...
    // then
    final SearchQueryOption queryVariant = searchRequest.queryOperation();
        ...
        .isInstanceOfSatisfying(
            ...
            (boolQuery) -> {
              assertThat(boolQuery.must())
                  .anySatisfy(
                      query ->
                          assertThat(query.queryOperation())
                              .isInstanceOfSatisfying(
    ...
    assertThat(queryVariant)
        .isInstanceOfSatisfying(
            SearchBoolQuery.class,
            (t) -> {
              assertThat(t.must().get(1).queryOperation())
                  .isInstanceOfSatisfying(
  ...
  public void shouldQueryByUserTaskKey() {
    ...
    assertThat(queryVariant)
        .isInstanceOfSatisfying(
            SearchBoolQuery.class,
            (t) -> {
              assertThat(t.must().get(0).queryOperation())
                  .isInstanceOfSatisfying(
                      SearchTermQuery.class,
                      (term) -> {
    ...
    assertThat(queryVariant)
        .isInstanceOfSatisfying(
            ...
            outerBoolQuery -> {
              ...
              assertThat(outerMustQuery.queryOperation()).isInstanceOf(SearchHasParentQuery.class);

              // Drill down into the nested SearchBoolQuery
              final SearchHasParentQuery nestedHasParentQuery =
                  (SearchHasParentQuery) outerMustQuery.queryOperation();
              ...
              final SearchHasChildQuery childQuery =
                  (SearchHasChildQuery) nestedHasParentQuery.query().queryOperation();
              ...
              final SearchBoolQuery innerBoolQuery =
                  (SearchBoolQuery) childQuery.query().queryOperation();
              assertThat(innerBoolQuery.must()).hasSize(2);

              assertThat(innerBoolQuery.must().get(0).queryOperation())
                  .isInstanceOfSatisfying(
                      SearchTermQuery.class,
                      termQuery -> {
              ...
              assertThat(innerBoolQuery.must().get(1).queryOperation())
                  .isInstanceOfSatisfying(
                      SearchTermQuery.class,
                      termQuery -> {
