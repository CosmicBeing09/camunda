    ...
    assertThat(queryVariant)
        .isInstanceOfSatisfying(
            ...
            outerBoolQuery -> {
              ...
              assertThat(nameMustQuery.queryOperation()).isInstanceOf(SearchTermQuery.class);

              final SearchQuery valueMustQuery = outerBoolQuery.must().get(1);
              assertThat(valueMustQuery.queryOperation()).isInstanceOf(SearchTermQuery.class);

              final SearchTermQuery innerNameTermQuery =
                  (SearchTermQuery) nameMustQuery.queryOperation();
              final SearchTermQuery innerValueTermQuery =
                  (SearchTermQuery) valueMustQuery.queryOperation();
