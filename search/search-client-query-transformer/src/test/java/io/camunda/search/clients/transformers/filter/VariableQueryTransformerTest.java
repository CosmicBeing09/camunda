    ...
    assertThat(queryVariant)
        .isInstanceOfSatisfying(
            ...
            outerBoolQuery -> {
              ...
              assertThat(nameMustQuery.searchOption()).isInstanceOf(SearchTermQuery.class);

              final SearchQuery valueMustQuery = outerBoolQuery.must().get(1);
              assertThat(valueMustQuery.searchOption()).isInstanceOf(SearchTermQuery.class);

              final SearchTermQuery innerNameTermQuery =
                  (SearchTermQuery) nameMustQuery.searchOption();
              final SearchTermQuery innerValueTermQuery =
                  (SearchTermQuery) valueMustQuery.searchOption();
