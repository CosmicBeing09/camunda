...
public final class ProcessInstanceQueryTransformerTest extends AbstractTransformerTest {
  ...
  public void shouldQueryByProcessInstanceKey() {
    ...
    assertIsSearchTermQuery(
        ((SearchBoolQuery) queryVariant).must().get(0).searchOption(),
        "joinRelation",
        "processInstance");
    assertIsSearchTermQuery(
        ((SearchBoolQuery) queryVariant).must().get(1).searchOption(), "key", 123L);
  }
  ...
  public void shouldQueryByProcessDefinitionId() {
    ...
    assertIsSearchTermQuery(
        ...
        "processInstance");
    assertIsSearchTermQuery(
        ((SearchBoolQuery) queryVariant).must().get(1).searchOption(), "bpmnProcessId", "bpmn");
  }
  ...
  public void shouldQueryByProcessDefinitionName() {
    ...
    assertIsSearchTermQuery(
        ...
        "processInstance");
    assertIsSearchTermQuery(
        ((SearchBoolQuery) queryVariant).must().get(1).searchOption(),
        "processName",
        "Demo Process");
  }
  ...
  public void shouldQueryByProcessDefinitionVersion() {
    ...
    assertIsSearchTermQuery(
        ...
        "processInstance");
    assertIsSearchTermQuery(
        ((SearchBoolQuery) queryVariant).must().get(1).searchOption(), "processVersion", 33);
  }
  ...
  public void shouldQueryByProcessDefinitionVersionTag() {
    ...
    assertIsSearchTermQuery(
        ...
        "processInstance");
    assertIsSearchTermQuery(
        ((SearchBoolQuery) queryVariant).must().get(1).searchOption(), "processVersionTag", "v1");
  }
  ...
  public void shouldQueryByProcessDefinitionKey() {
    ...
    assertIsSearchTermQuery(
        ...
        "processInstance");
    assertIsSearchTermQuery(
        ((SearchBoolQuery) queryVariant).must().get(1).searchOption(), "processDefinitionKey", 567L);
  }
  ...
  public void shouldQueryByStartDateAndEndDate() {
    ...
    assertThat(((SearchBoolQuery) queryVariant).must().get(2).searchOption())
        .isInstanceOfSatisfying(
            SearchRangeQuery.class,
            (searchRangeQuery) -> {
  ...
  public void shouldQueryByState() {
    ...
    assertIsSearchTermQuery(
        ...
        "processInstance");
    assertIsSearchTermQuery(
        ((SearchBoolQuery) queryVariant).must().get(1).searchOption(), "state", "ACTIVE");
  }
  ...
  public void shouldQueryByIncident() {
    ...
    assertIsSearchTermQuery(
        ...
        "processInstance");
    assertIsSearchTermQuery(
        ((SearchBoolQuery) queryVariant).must().get(1).searchOption(), "incident", true);
  }
  ...
  public void shouldQueryByTenantId() {
    ...
    assertIsSearchTermQuery(
        ...
        "processInstance");
    assertIsSearchTermQuery(
        ((SearchBoolQuery) queryVariant).must().get(1).searchOption(), "tenantId", "tenant");
  }
  ...
  public void shouldQueryByErrorMessage() {
    ...
    assertIsSearchTermQuery(
        boolQuery.must().get(0).searchOption(), "joinRelation", "processInstance");

    // Second must clause: should be a has_child query for errorMessage.
    assertThat(boolQuery.must().get(1).searchOption())
        ...
        .satisfies(
            queryOption -> {
              ...
              // expected value.
              assertThat(hasChildQuery.query().searchOption())
                  .isInstanceOfSatisfying(
  ...
  public void shouldQueryByHasRetriesLeft() {
    ...
    assertIsSearchTermQuery(
        ((SearchBoolQuery) queryVariant).must().getFirst().searchOption(),
        "joinRelation",
        "processInstance");
    ...
    assertThat(((SearchBoolQuery) queryVariant).must().get(1).searchOption())
        .isInstanceOfSatisfying(
            ...
            (searchHasChildQuery) -> {
              assertIsSearchTermQuery(
                  searchHasChildQuery.query().searchOption(), "jobFailedWithRetriesLeft", true);
            });
  }
  ...
  public void shouldQueryByFlowNodeId() {
    ...
    assertIsSearchTermQuery(
        ...
        "processInstance");
    assertIsSearchTermQuery(
        ((SearchBoolQuery) queryVariant).must().get(1).searchOption(), "processDefinitionKey", 123L);
    ...
    assertThat(((SearchBoolQuery) queryVariant).must().get(2).searchOption())
        .isInstanceOfSatisfying(
            ...
            hasChildQuery -> {
              assertIsSearchTermQuery(
                  (hasChildQuery.query().searchOption()), "activityId", "activity_123");
              assertThat(hasChildQuery.type()).isEqualTo("activity");
            });
  }
            ...
            hasChildQuery -> {
              assertThat(hasChildQuery.query().searchOption())
                  .isInstanceOfSatisfying(
                      ...
                      boolQuery -> {
                        assertIsSearchTermQuery(
                            boolQuery.must().getFirst().searchOption(),
                            "activityId",
                            "activity_123");
                        assertThat(boolQuery.must().get(1).searchOption())
                            .isInstanceOfSatisfying(
                ...
                assertThat(hasChildQuery.query().searchOption())
                    .isInstanceOfSatisfying(
                        ...
                        boolQuery -> {
                          ...
                          assertIsSearchTermQuery(
                              boolQuery.must().get(2).searchOption(), "incident", true);
                        });
  ...
  public void shouldQueryWithOrConditions() {
    ...
    assertIsSearchTermQuery(
        outerBool.must().get(0).searchOption(), "joinRelation", "processInstance");
    assertIsSearchTermQuery(outerBool.must().get(1).searchOption(), "tenantId", "tenant-1");

    assertThat(outerBool.must().get(2).searchOption())
        .isInstanceOfSatisfying(
            SearchBoolQuery.class,
            orBool -> {
              assertThat(orBool.should()).hasSize(2);
              assertThat(orBool.should().get(0).searchOption())
                  .isInstanceOfSatisfying(
                      SearchBoolQuery.class,
                      orBool2 -> {
                        assertIsSearchTermQuery(
                            orBool2.must().get(0).searchOption(), "state", "ACTIVE");
                        assertIsSearchTermQuery(
                            orBool2.must().get(1).searchOption(), "incident", true);
                      });
              assertThat(orBool.should().get(1).searchOption())
                  .isInstanceOfSatisfying(
                      SearchBoolQuery.class,
                      orBool3 -> {
                        assertIsSearchTermQuery(
                            orBool3.must().get(0).searchOption(), "state", "COMPLETED");
                        assertIsSearchTermQuery(
                            orBool3.must().get(1).searchOption(), "incident", false);
                      });
            });
  }
