...
public final record SearchQuery(SearchQueryOption searchOption) {
  ...
  public static final class Builder implements ObjectBuilder<SearchQuery> {
    ...
    private SearchQueryOption searchOption;
    ...
    public Builder matchAll() {
      searchOption = new SearchMatchAllQuery.Builder().build();
      return this;
    }

    public Builder matchNone(final SearchMatchNoneQuery query) {
      searchOption = new SearchMatchNoneQuery.Builder().build();
      return this;
    }
    ...
    public SearchQuery build() {
      return new SearchQuery(searchOption);
    }
  }
}
