...
public final record SearchQuery(SearchQueryOption queryOperations) {
  ...
  public static final class Builder implements ObjectBuilder<SearchQuery> {
    ...
    private SearchQueryOption queryOperations;
    ...
    public Builder matchAll() {
      queryOperations = new SearchMatchAllQuery.Builder().build();
      return this;
    }

    public Builder matchNone(final SearchMatchNoneQuery query) {
      queryOperations = new SearchMatchNoneQuery.Builder().build();
      return this;
    }
    ...
    public SearchQuery build() {
      return new SearchQuery(queryOperations);
    }
  }
}
