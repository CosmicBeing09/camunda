...
public record Operation<T>(Operator operator, List<T> valueList) {

  public Operation(final Operator operator, final T singleValue) {
    this(operator, CollectionUtil.collectValuesAsList(singleValue));
  }
