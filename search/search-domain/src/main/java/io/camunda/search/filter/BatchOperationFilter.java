...
public record BatchOperationFilter(
  ...
  public static final class Builder implements ObjectBuilder<BatchOperationFilter> {
    ...
    public Builder operationTypeOperations(final List<String> operations) {
      operationTypeOperations = addValuesToList(operationTypeOperations, operations);
      return this;
    }

    public Builder stateOperations(final String value, final String... values) {
      return stateOperations(collectValues(value, values));
    }

    public Builder stateOperations(final List<String> values) {
