...
FilterBase {
  ...
  public static final class Builder implements ObjectBuilder<BatchOperationFilter> {
    ...
    public Builder operationStates(final String value, final String... values) {
      return operationStates(collectValues(value, values));
    }

    public Builder operationStates(final List<String> values) {
      operationStates = addValuesToList(operationStates, values);
      return this;
    }
    ...
    public BatchOperationFilter build() {
      return new BatchOperationFilter(
          ...
          Objects.requireNonNullElse(operationStates, Collections.emptyList()));
    }
  }
}
    implements
