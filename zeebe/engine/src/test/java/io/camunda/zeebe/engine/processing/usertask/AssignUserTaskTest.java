  ...
  public void shouldUnassignUserTaskWithNoAssignee() {
    ...
    assertThat(
        ...
        .containsExactly(
            ...
            // as it becomes effective only during the assignment phase.
            tuple(UserTaskIntent.ASSIGNING, initialAssignee, "", List.of(TaskRecord.ASSIGNEE)),
            tuple(UserTaskIntent.ASSIGNED, initialAssignee, "", List.of(TaskRecord.ASSIGNEE)),
            // records related to user task unassignment
            tuple(UserTaskIntent.ASSIGNING, "", unassignAction, List.of(TaskRecord.ASSIGNEE)),
            tuple(UserTaskIntent.ASSIGNED, "", unassignAction, List.of(TaskRecord.ASSIGNEE)));
  }
