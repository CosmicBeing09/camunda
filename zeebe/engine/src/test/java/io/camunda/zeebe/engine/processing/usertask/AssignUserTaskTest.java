  ...
  public void shouldUnassignUserTaskWithNoAssignee() {
    ...
    assertThat(
        ...
        .containsExactly(
            ...
            // as it becomes effective only during the assignment phase.
            tuple(TaskIntent.ASSIGNING, initialAssignee, "", List.of(UserTaskRecord.ASSIGNEE)),
            tuple(TaskIntent.ASSIGNED, initialAssignee, "", List.of(UserTaskRecord.ASSIGNEE)),
            // records related to user task unassignment
            tuple(TaskIntent.ASSIGNING, "", unassignAction, List.of(UserTaskRecord.ASSIGNEE)),
            tuple(TaskIntent.ASSIGNED, "", unassignAction, List.of(UserTaskRecord.ASSIGNEE)));
  }
