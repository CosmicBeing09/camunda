...
public final class UserTaskClient {
  ...
  private final UserTaskEntity userTaskRecord;
  ...
  public UserTaskClient(final CommandWriter writer) {
    this.writer = writer;
    userTaskRecord = new UserTaskEntity();
  }
  ...
  /**
   * Adds a custom attribute to the {@code changedAttributes} list of the {@link UserTaskEntity}.
   *
   ...
   * construct the {@link UserTaskEntity} with the appropriate changed attributes. Only explicitly
