...
public final class AsyncProcessingBehavior {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(AsyncProcessingBehavior.class.getPackageName());
  ...
  public AsyncProcessingBehavior(
  ...
  public Either<Failure, AsyncJobProperties> evaluateJobExpressions(
      final JobWorkerProperties jobWorkerProps, final BpmnElementContext context) {
    final var scopeKey = context.getElementInstanceKey();
    return Either.<Failure, AsyncJobProperties>right(new AsyncJobProperties())
        ...
        .flatMap(
            p ->
                userTaskBehavior
                    ...
                    .map(AsyncProcessingBehavior::asListLiteralOrNull)
  ...
  public void createNewJob(
      ...
      final AsyncJobProperties jobProperties) {
  ...
  private Either<Failure, AsyncJobProperties> evaluateTaskListenerJobExpressions(
        ...
        .map(
            p ->
                Optional.of(taskRecordValue.getAssignee())
                    .map(AsyncProcessingBehavior::notBlankOrNull)
                    .map(p::assignee)
                    .orElse(p))
        .map(
            p ->
                Optional.of(taskRecordValue.getCandidateGroupsList())
                    .map(AsyncProcessingBehavior::asNotEmptyListLiteralOrNull)
                    .map(p::candidateGroups)
                    .orElse(p))
        .map(
            p ->
  ...
  private void writeJobCreatedEvent(
      final BpmnElementContext context,
      final AsyncJobProperties props,
  ...
  private DirectBuffer encodeHeaders(
      final Map<String, String> taskHeaders, final AsyncJobProperties props) {
  ...
  public static final class AsyncJobProperties {
    private String type;
    ...
    public AsyncJobProperties type(final String type) {
      this.type = type;
      return this;
    }
    ...
    public AsyncJobProperties retries(final Long retries) {
    ...
    public AsyncJobProperties assignee(final String assignee) {
    ...
    public AsyncJobProperties candidateGroups(final String candidateGroups) {
    ...
    public AsyncJobProperties candidateUsers(final String candidateUsers) {
    ...
    public AsyncJobProperties dueDate(final String dueDate) {
    ...
    public AsyncJobProperties followUpDate(final String followUpDate) {
    ...
    public AsyncJobProperties formKey(final String formId) {
      formKey = formId;
      return this;
    }
    ...
    public AsyncJobProperties linkedResources(final List<LinkedResourceProps> linkedResources) {
