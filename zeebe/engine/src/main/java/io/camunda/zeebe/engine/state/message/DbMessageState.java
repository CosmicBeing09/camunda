...
public final class DbMessageState implements MutableMessageState {
  ...
  public void putMessageCorrelation(final long messageKey, final DirectBuffer bpmnProcessId) {
    ...
    bpmnProcessIdKey.recordBufferContent(bpmnProcessId);
    correlatedMessageColumnFamily.recordEntry(messageBpmnProcessIdKey, DbNil.INSTANCE);
  }
  ...
  public void putActiveProcessInstance(
    ...
    activeProcessInstancesByCorrelationKeyColumnFamily.recordEntry(
  ...
  public void putProcessInstanceCorrelationKey(
    ...
    this.processInstanceKey.recordValue(processInstanceKey);
    this.correlationKey.recordBufferContent(correlationKey);
    processInstanceCorrelationKeyColumnFamily.recordEntry(this.processInstanceKey, this.correlationKey);
  }
  ...
  public void remove(final long key) {
    ...
    messageKey.recordValue(storedMessage.getMessageKey());
    messageColumnFamily.deleteExisting(messageKey);

    tenantIdKey.recordStringContent(storedMessage.getMessage().getTenantIdentifier());
    messageName.recordBufferContent(storedMessage.getMessage().getNameBuffer());
    correlationKey.recordBufferContent(storedMessage.getMessage().getCorrelationKeyBuffer());
    ...
    deadline.recordValue(storedMessage.getMessage().getDeadline());
  ...
  public void visitMessages(
    ...
    messageName.recordBufferContent(name);
    this.correlationKey.recordBufferContent(correlationKey);
  ...
  public boolean visitMessagesWithDeadlineBeforeTimestamp(
    ...
    if (startAt != null) {
      deadline.recordValue(startAt.deadline());
      messageKey.recordValue(startAt.key());
