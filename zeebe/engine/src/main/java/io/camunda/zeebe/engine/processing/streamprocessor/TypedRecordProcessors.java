...
public final class TypedRecordProcessors {
  ...
  private TypedRecordProcessors(final VariableDocKeyGenerator keyGenerator, final Writers writers) {
    this.keyGenerator = keyGenerator;
    this.writers = writers;
  }

  public static TypedRecordProcessors processors(
      final VariableDocKeyGenerator keyGenerator, final Writers writers) {
