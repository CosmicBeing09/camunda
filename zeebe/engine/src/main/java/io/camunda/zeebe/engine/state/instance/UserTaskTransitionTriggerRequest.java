...
/**
 * Represents the request details for tracking the request that triggered a user task transition.
 *
 ...
 */
public class UserTaskTransitionTriggerRequest extends UnpackedObject implements DbValue {
  ...
  public UserTaskTransitionTriggerRequest() {
    super(4);
   ...
   */
  public UserTaskTransitionTriggerRequest setTriggerType(final ValueType triggerType) {
   ...
   * @return this metadata instance.
   */
  public UserTaskTransitionTriggerRequest setIntent(final Intent intent) {
   ...
   * @return this metadata instance.
   */
  public UserTaskTransitionTriggerRequest setRequestId(final long requestId) {
   ...
   * @return this metadata instance.
   */
  public UserTaskTransitionTriggerRequest setRequestStreamId(final int requestStreamId) {
