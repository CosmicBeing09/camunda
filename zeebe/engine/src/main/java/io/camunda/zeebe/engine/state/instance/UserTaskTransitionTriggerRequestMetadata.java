...
public class UserTaskTransitionTriggerRequestMetadata extends UnpackedObject implements DbValue {
  ...
  private final StringProperty userTaskIntentProperty = new StringProperty("intent");
  ...
  public UserTaskTransitionTriggerRequestMetadata() {
    ...
    declareProperty(triggerTypeProperty)
        .declareProperty(userTaskIntentProperty)
   ...
   */
  public Intent getUserTaskIntent() {
    return Intent.fromProtocolValue(
        triggerTypeProperty.getValue(), BufferUtil.bufferAsString(userTaskIntentProperty.getValue()));
  }
  ...
  public UserTaskTransitionTriggerRequestMetadata setIntent(final Intent intent) {
    userTaskIntentProperty.setValue(intent.name());
    return this;
  }
