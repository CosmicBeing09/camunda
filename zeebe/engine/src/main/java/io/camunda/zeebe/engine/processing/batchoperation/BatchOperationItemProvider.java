...
public class BatchOperationItemProvider {
   ...
   * @param lastSearchAfter the cursor values for pagination
   * @param total the total amount of found items
   */
  private record ItemPage(List<Item> items, Object[] lastSearchAfter, long total) {}
  ...
  private interface ItemPageFetcher<F extends FilterBase> {
     ...
     * @param searchAfter the cursor values
