...
public final class DbEventScopeInstanceState implements MutableEventScopeInstanceState {
  ...
  public void createInstance(
    ...
    this.eventScopeKey.recordValue(eventScopeKey);
    ...
    eventScopeInstanceColumnFamily.recordEntry(this.eventScopeKey, eventScopeInstance);
  }

  @Override
  public void deleteInstance(final long eventScopeKey) {
    eventTriggerScopeKey.recordValue(eventScopeKey);
  ...
  public void triggerEvent(
    ...
    if (canTriggerEvent(instance, elementId)) {
      ...
      eventScopeInstanceColumnFamily.updateEntry(this.eventScopeKey, instance);
  ...
  public void deleteTrigger(final long eventScopeKey, final long eventKey) {
    eventTriggerScopeKey.recordValue(eventScopeKey);
    eventTriggerEventKey.recordValue(eventKey);
  ...
  private void createTrigger(
    ...
    eventTriggerColumnFamily.recordEntry(eventTriggerKey, eventTrigger);
  }
