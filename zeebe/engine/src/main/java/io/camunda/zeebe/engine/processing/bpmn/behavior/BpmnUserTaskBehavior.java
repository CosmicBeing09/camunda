...
public final class BpmnUserTaskBehavior {
  ...
  public UserTaskEntity createNewUserTask(
  ...
  public Optional<UserTaskEntity> userTaskCanceling(final ElementInstance elementInstance) {
    ...
    final UserTaskEntity userTask = userTaskState.getUserTask(userTaskKey);
    if (userTask == null) {
      return Optional.empty();
    }
  ...
  public void userTaskCanceled(final UserTaskEntity userTaskRecord) {
  ...
  public void userTaskCreated(final UserTaskEntity userTaskRecord) {
    final long userTaskKey = userTaskRecord.getUserTaskKey();
    stateWriter.appendFollowUpEvent(userTaskKey, UserTaskIntent.CREATED, userTaskRecord);
  }

  public void userTaskAssigning(final UserTaskEntity userTaskRecord, final String assignee) {
    final long userTaskKey = userTaskRecord.getUserTaskKey();
  ...
  public void userTaskAssigned(final UserTaskEntity userTaskRecord, final String assignee) {
    final long userTaskKey = userTaskRecord.getUserTaskKey();
    userTaskRecord.setAssignee(assignee);
