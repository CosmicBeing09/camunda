...
public interface VariableState {
  ...
  /**
   * Attempts to retrieve the persisted {@link AsyncDocumentState} for the given scope key.
   *
   ...
   * @return an {@link Optional} containing the {@link AsyncDocumentState} if found
   */
  Optional<AsyncDocumentState> findVariableDocumentState(long scopeKey);
