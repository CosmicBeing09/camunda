...
public class DbUserTaskState implements MutableUserTaskState {
  ...
  private final UserTaskRecordValue userTaskReadBuffer = new UserTaskRecordValue();
  private final UserTaskRecordValue userTaskWriteBuffer = new UserTaskRecordValue();
  ...
  public DbUserTaskState(
    ...
    userTasksColumnFamily =
        zeebeDb.createColumnFamily(
            ZbColumnFamilies.USER_TASKS, transactionContext, userTaskKey, userTaskReadBuffer);
  ...
  public void create(final UserTaskRecord userTask) {
    ...
    userTaskWriteBuffer.setRecordWithoutVariables(userTask);
    userTasksColumnFamily.insert(userTaskKey, userTaskWriteBuffer);
    // initialize state
  ...
  public void update(final UserTaskRecord userTask) {
    ...
    // do not persist variables in user task state
    userTaskWriteBuffer.setRecordWithoutVariables(userTask);
    userTasksColumnFamily.update(userTaskKey, userTaskWriteBuffer);
  }
