...
public final class DbDecisionState implements MutableDecisionState {
  ...
  public Optional<PersistedDecision> findLatestDecisionByIdAndTenant(
    ...
    dbDecisionId.setValueFromBuffer(decisionId);
  ...
  public Optional<PersistedDecision> findDecisionByTenantAndKey(
    ...
    dbDecisionKey.setValue(decisionKey);
    tenantIdKey.setValueFromString(tenantId);
  ...
  public Optional<DeployedDrg> findLatestDecisionRequirementsByTenantAndId(
    ...
    tenantIdKey.setValueFromString(tenantId);
    dbDecisionRequirementsId.setValueFromBuffer(decisionRequirementsId);
  ...
  public List<PersistedDecision> findDecisionsByTenantAndDecisionRequirementsKey(
    ...
    tenantIdKey.setValueFromString(tenantId);
    dbDecisionRequirementsKey.setValue(decisionRequirementsKey);
  ...
  public void forEachDecisionRequirements(
    ...
    if (previousDecisionsRequirements == null) {
      ...
      tenantIdKey.setValueFromString(previousDecisionsRequirements.tenantId());
      dbDecisionRequirementsKey.setValue(previousDecisionsRequirements.decisionRequirementsKey());
  ...
  public void storeDecisionRequirements(final DecisionRequirementsRecord record) {
    ...
    dbDecisionRequirementsId.setValueFromString(record.getDecisionRequirementsId());
  ...
  public void deleteDecision(final DecisionRecord record) {
        ...
        .ifPresent(
            latestVersion -> {
              if (latestVersion == record.getVersion()) {
                dbDecisionId.setValueFromBuffer(record.getDecisionIdBuffer());
                findPreviousVersionDecisionKey(
                    ...
                    .ifPresentOrElse(
                        previousDecisionKey -> {
                          ...
                          dbDecisionKey.setValue(previousDecisionKey);
    ...
    dbDecisionVersion.wrapInt(record.getVersion());
    dbDeploymentKey.setValue(record.getDeploymentKey());
    dbVersionTag.setValueFromString(record.getVersionTag());
        ...
        .ifPresent(
            latestVersion -> {
              if (latestVersion == record.getDecisionRequirementsVersion()) {
                dbDecisionRequirementsId.setValueFromBuffer(record.getDecisionRequirementsIdBuffer());
                findPreviousVersionDecisionRequirementsKey(
                    ...
                    .ifPresentOrElse(
                        previousDrgKey -> {
                          // Update the latest decision version
                          dbDecisionRequirementsKey.setValue(previousDrgKey);
  ...
  public void setMissingDeploymentKey(
    ...
    dbDecisionId.setValueFromBuffer(decision.getDecisionId());
    decisionKeyByDecisionIdAndDeploymentKey.upsert(
        tenantAwareDecisionIdAndDeploymentKey, fkDecision);
