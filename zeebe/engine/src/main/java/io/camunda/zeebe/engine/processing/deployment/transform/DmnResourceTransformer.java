...
public final class DmnResourceTransformer implements DeploymentResourceTransformer {
        ...
        .ifPresent(
            drg -> {
              ...
              if (drg.isDuplicate()) {
                ...
                drgKey = keyGenerator.nextVariableDocKey();
                  ...
                  .forEach(
                      decision -> {
                        ...
                        if (decision.isDuplicate()) {
                          decisionKey = keyGenerator.nextVariableDocKey();
                          decision
  ...
  private void appendMetadataToDeploymentEvent(
    ...
    final LongSupplier newDecisionRequirementsKey = keyGenerator::nextVariableDocKey;
    ...
    parsedDrg
        ...
        .forEach(
            decision -> {
              final LongSupplier newDecisionKey = keyGenerator::nextVariableDocKey;
