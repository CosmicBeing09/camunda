 ...
 */
public class UserTaskCancellation extends UnpackedObject implements DbValue {
   ...
   */
  public UserTaskCancellation setTriggerType(final ValueType triggerType) {
   ...
   * @return this metadata instance.
   */
  public UserTaskCancellation setIntent(final Intent intent) {
   ...
   * @return this metadata instance.
   */
  public UserTaskCancellation setRequestId(final long requestId) {
   ...
   * @return this metadata instance.
   */
  public UserTaskCancellation setRequestStreamId(final int requestStreamId) {
