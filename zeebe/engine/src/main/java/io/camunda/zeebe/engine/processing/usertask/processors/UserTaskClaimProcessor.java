...
public final class UserTaskClaimProcessor implements TaskCommandProcessor {
  ...
  public void onCommand(
    ...
    stateWriter.appendFollowUpEvent(userTaskKey, TaskIntent.CLAIMING, userTaskRecord);
  }
  ...
  private static Either<Rejection, TaskRecord> checkClaim(
      final TypedRecord<TaskRecord> command, final TaskRecord userTaskRecord) {
