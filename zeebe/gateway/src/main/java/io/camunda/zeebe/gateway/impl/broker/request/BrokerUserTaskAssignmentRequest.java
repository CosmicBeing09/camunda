...
public class BrokerUserTaskAssignmentRequest extends BrokerExecuteCommand<TaskRecord> {

  private final TaskRecord requestDto = new TaskRecord();

  public BrokerUserTaskAssignmentRequest(
      final long key, final String assignee, final String action, final TaskIntent intent) {
